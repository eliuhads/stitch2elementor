...
delete_post_meta(22, '_elementor_css');
delete_post_meta(22, '_elementor_inline_svg');
delete_post_meta(22, '_elementor_page_assets');
update_post_meta(22, '_elementor_version', '0.0.0');
clean_post_cache(22);
